  ...
  module Entities
    class ResultEntryTest < Minitest::Test
      ...
      def test_when_passed_invalid
        ...
        instance << OpenStruct.new(page: '/page')
        instance << OpenStruct.new(ip: '1.2.3.4')
        instance << OpenStruct.new(page: '/page', ip: '1.2.3.4', valid?: false)
      ...
      def test_when_passed_valid
        instance = ResultEntry.new
        instance << OpenStruct.new(page: '/page', ip: '1.2.3.4', valid?: true)
        instance << OpenStruct.new(page: '/page', ip: '1.2.3.5', valid?: true)
        instance << OpenStruct.new(page: '/page', ip: '1.2.3.5', valid?: true)
        instance << OpenStruct.new(page: '/test', ip: '1.2.3.4', valid?: true)
